...
import ChatInterface from './widgets/ChatInterface.vue'
    ...
    methods: {
        ...
        addChatButton () {
            ...
            chatButton.addEventListener('click', () => {
                this.$nextTick(function () {
                    // this.$eventHub.$emit('open-chat-interface')
                    this.state.showChatInterface = true
                })
            })
        },
        ...
        handleChatInterfaceLoad () {
            this.$eventHub.$emit('getAllFlightsData')
        },
        onCameraUpdate () {
