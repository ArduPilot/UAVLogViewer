...
class IntentRouterAgent:
    def __init__(self, session_id: str, store: SessionStore):
        ...
        self.INTENT_SYSTEM = SystemMessage(content=(
            ...
            "  This may include narrowing the scope, asking for more detail, or correcting the assistant.\n"
            "  Typical signals: 'I meant...', 'Can you also...', 'Zoom in...', 'More detail about...'\n"
            "  Examples:\n"
    ...
    def classify_intent_llm(self, msg: str) -> str:
        ...
        history = self.store.get_history(self.session_id)[-3:]  # keeping it concise, no need to include long history
